...
export default function InfiniteMenu({ items = [] }) {
  ...
  const handleButtonClick = () => {
    ...
    if(activeItem.title === "My Resume") {
        const pdfUrl = process.env.PUBLIC_URL + '/Aayush_Resume.pdf';
        const a = document.createElement('a');
        a.href = pdfUrl;
        a.download = 'Aayush_Resume.pdf';
    ...
    <div className="relative w-full h-full">
      ...
      {activeItem && (
        <>
          ...
          ${activeItem.style ? activeItem.style : ''}
        `}
          >
            {activeItem.title}
          </h2>
          ...
          ${isMoving
                ...
                : 'opacity-0 lg:opacity-100 pointer-events-auto duration-[500ms] translate-x-[-90%] -translate-y-1/2'
              }
        `}
          >
        ...
        `}
          >
            <p className="select-none relative text-[#060010] top-[1px] text-[26px]">
              &#x2197;
            </p>
          </div>
        </>
